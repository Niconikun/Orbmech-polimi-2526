...
t_dep_e = date2mjd2000([2041, 6, 23, 0, 0, 0]);
t_dep_l = date2mjd2000([2045, 6, 25, 0, 0, 0]);
departure_dates = linspace(t_dep_e, t_dep_l, n_points);

% Gravity assist at Mars
t_ga_e = date2mjd2000([2042, 3, 8, 0, 0, 0]);
t_ga_l = date2mjd2000([2045, 3, 10, 0, 0, 0]);
ga_dates = linspace(t_ga_e, t_ga_l, n_points);

% Arrival at asteroid
t_arr_e = date2mjd2000([2042, 8, 2, 0, 0, 0]);
t_arr_l = date2mjd2000([2045, 8, 4, 0, 0, 0]);
