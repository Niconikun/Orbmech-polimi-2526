...
[r0, v0] = kep2car([a,e,i,Omega,omega,f0],mu);
...
lon_diff = abs(lon_1(end) - lon_2(end)) * 180/pi;
lat_diff = abs(lat_1(end) - lat_2(end)) * 180/pi;
...
disp(lat_3(end) * 180/pi);
disp(lon_3(end) * 180/pi);
